describe("Multiplication test suite", function() {
    ...
    it('should return 6 if append 2 and 3', function() {
        calculator.appendNumber(2);
        calculator.chooseOperation('*');
        calculator.appendNumber(3);
        calculator.compute();
        calculator.updateDisplay();
        expect(currentOperandElement.innerText).toEqual('6');
    });

    it('should return 4 if append 1.5 and 3', function() {
